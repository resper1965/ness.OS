...
| ----- | ------------------- | ------------------------------------------------------------------------------------------------------------------- |
| **1** | A Trava do Catálogo | O sistema impede criação de serviço sem vínculo com **Service Actions** validadas. Evita venda de vaporware.        |
...
| ------------- | ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| **RF.GRO.01** | Catálogo de Serviços (A Trava) | CRUD de Serviços. Regra: Exige vínculo com **Service Actions** (que agrupam SOPs/Playbooks). marketing_title e marketing_body → /solucoes/[slug] |
