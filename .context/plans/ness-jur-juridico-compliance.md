...
planVinculado: docs/PLANO-NESS-JUR-JURIDICO-COMPLIANCE.md
agents:
  - type: "code-reviewer"
...
**Documento completo:** [docs/PLANO-NESS-JUR-JURIDICO-COMPLIANCE.md](../docs/PLANO-NESS-JUR-JURIDICO-COMPLIANCE.md)

**Código do plano:** `JUR-CP` | **Pilares:** ARC, CC | **Commits:** `jur-cp:`

**RF.CORE:** 01 Auth Guard | 02 Dashboard por Role — ver docs/RF-CORE-REQUISITOS.md

## Task Snapshot
- **Primary goal:** ness.JUR: Análise de Risco Contratual (IA em minutas) e Conformidade Contínua (LGPD, Marco Civil, leis trabalhistas).
- **Success signal:** Minutas analisadas por IA antes de envio; processos mapeados a requisitos de conformidade.
- **Key references:**
