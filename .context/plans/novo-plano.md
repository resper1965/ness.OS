...
## Codebase Context
- **Total files analyzed:** 805
- **Total symbols discovered:** 835
- **Architecture layers:** Utils, Models, Repositories, Components, Controllers, Services
- **Detected patterns:** Service Layer
- **Entry points:** src/lib/supabase/server.ts, _reference/legacy_site/lib/supabase/server.ts, _reference/corp-site-ness/lib/supabase/server.ts (+72 more)
...
- `ButtonProps` — /home/resper/nessOS/ness.OS/_reference/corp-site-ness/components/ui/button.tsx:48
- `BadgeProps` — /home/resper/nessOS/ness.OS/_reference/corp-site-ness/components/ui/badge.tsx:26
## Agent Lineup
