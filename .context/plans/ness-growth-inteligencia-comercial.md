...
> Motor de Vendas e alimentação do Site Público. Trava do Catálogo (playbook_id). Integração Site (Case, Vaga → site). Agentes: Propostas (cliente+playbook→minuta) e Conteúdo (case→post).

**Documento completo:** [docs/PLANO-NESS-GROWTH-INTELIGENCIA-COMERCIAL.md](../docs/PLANO-NESS-GROWTH-INTELIGENCIA-COMERCIAL.md)

**Código do plano:** `GROWTH-IC` | **Pilares:** SP, PDU, MC, CR, BG | **Commits:** `growth-ic:`

**RF.CORE:** 01 Auth Guard | 02 Dashboard por Role — ver docs/RF-CORE-REQUISITOS.md

**RF.GRO:** 01 Catálogo (Trava) | 02 Leads | 03 CMS Blog | 04 Integração Site (Case, Vaga → site) | 05 Agente Propostas | 06 Agente Conteúdo

## Task Snapshot
- **Primary goal:** Elevar ness.GROWTH a motor de receita com IA (propostas, precificação, conteúdo, chatbot público, branding).
- **Success signal:** Propostas geradas por IA, chatbot no site, precificação dinâmica, conteúdo automatizado.
- **Key references:**
