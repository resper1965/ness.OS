...
**Documento completo:** [docs/PLANO-NESS-FIN-CFO-DIGITAL.md](../docs/PLANO-NESS-FIN-CFO-DIGITAL.md)

**Código do plano:** `FIN-CFO` | **Pilares:** CEP, RLR, GCV | **Commits:** `fin-cfo:`

**RF.CORE:** 01 Auth Guard | 02 Dashboard por Role — ver docs/RF-CORE-REQUISITOS.md

**RF.FIN:** 01 Gestão de Contratos (MRR, Início, Renovação, Índice Reajuste) | 02 Rentabilidade (Fórmula: MRR − (Horas × Custo Hora + Custo Infra), alerta visual negativas)

## Task Snapshot
- **Primary goal:** CFO Digital: Conexão ERP, Rentabilidade Líquida Real (breakdown de custos), Gestão de Ciclo de Vida (alertas, reajustes).
- **Success signal:** Receita x Despesa em tempo real, identificação de clientes lucrativos vs. dreno, alertas de renovação e reajuste.
- **Key references:**
