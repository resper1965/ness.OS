...
planSlug: ness-os-desenvolvimento
planosVinculados:
  - docs/plan-github-artefatos-iniciais.md
  - docs/plan-ajuste-schema-ao-projeto.md
  - docs/plan-github-novos-passos-integracao.md
  - docs/plan-github-integracao-ai-context.md
  - docs/plan-implementacao-epicos-ai-context.md
  - docs/plan-ness-branding-ai-context.md
  - docs/plan-integracao-nessos-site-institucional.md
agents:
  - type: "code-reviewer"
...
# Planejamento de desenvolvimento ness.OS

> Consolida todos os planos existentes (artefatos, schema, GitHub, épicos, branding, integração site) no planejamento do projeto.

**Plano mestre consolidado:** [docs/PLANO-MESTRE-NESSOS](../../docs/PLANO-MESTRE-NESSOS.md) — decisões estratégicas, roadmap unificado, épicos, checklist.

## Task Snapshot
- **Primary goal:** Executar a implementação do ness.OS conforme DEVELOPMENT_PLAN (30 épicos, fases 0–7), com todos os planos existentes vinculados e AI-context atualizado.
- **Success signal:** Projeto funcional com módulos ness.FIN, ness.OPS, ness.GROWTH, ness.JUR, ness.GOV, ness.PEOPLE; AI-context e documentação alinhados.

## Planos existentes vinculados

| Plano | Caminho | Foco |
|-------|---------|------|
| Artefatos iniciais | [docs/plan-github-artefatos-iniciais](../../docs/plan-github-artefatos-iniciais.md) | SQL fin, sync-omie, SETUP, auth/RBAC |
| Ajuste schema | [docs/plan-ajuste-schema-ao-projeto](../../docs/plan-ajuste-schema-ao-projeto.md) | Migrations ops, growth, jur, gov, people, kb |
| GitHub novos passos | [docs/plan-github-novos-passos-integracao](../../docs/plan-github-novos-passos-integracao.md) | Integração commits GitHub → local → AI-context |
| GitHub integração | [docs/plan-github-integracao-ai-context](../../docs/plan-github-integracao-ai-context.md) | Fluxo reutilizável pull → planos → .context |
| Implementação épicos | [docs/plan-implementacao-epicos-ai-context](../../docs/plan-implementacao-epicos-ai-context.md) | 30 épicos, mapeamento Playbooks AI, workflow |
| ness. branding | [docs/plan-ness-branding-ai-context](../../docs/plan-ness-branding-ai-context.md) | Convenções ness., AI-context, Cursor rules |
| Integração site | [docs/plan-integracao-nessos-site-institucional](../../docs/plan-integracao-nessos-site-institucional.md) | Admin site → ness.OS; vagas→PEOPLE, conteúdo→GROWTH, processes/ncirt→OPS |

## Key references
- [DEVELOPMENT_PLAN](../../docs/DEVELOPMENT_PLAN.md) — Fonte de verdade dos épicos
- [DATABASE_SCHEMA](../../docs/DATABASE_SCHEMA.md) — Modelo completo
- [Documentation Index](../docs/README.md) · [Agent Handbook](../agents/README.md)

## Codebase Context
- **Total files analyzed:** 37
- **Total symbols discovered:** 96
- **Architecture layers:** Utils, Components
- **Entry points:** supabase/functions/sync-omie/index.ts, src/lib/supabase/server.ts, src/lib/auth/index.ts (+1 more)

### Key Components

**Key Interfaces:**
- `UserProfile` — /home/resper/nessOS/ness.OS/src/types/auth.ts:15
- `UserPreferences` — /home/resper/nessOS/ness.OS/src/types/auth.ts:32
- `UserPermission` — /home/resper/nessOS/ness.OS/src/types/auth.ts:40
- `UserPermissions` — /home/resper/nessOS/ness.OS/src/types/auth.ts:54
- `AuthContextType` — /home/resper/nessOS/ness.OS/src/types/auth.ts:69
## Agent Lineup
