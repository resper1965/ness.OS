...
planVinculado: docs/PLANO-NESS-PEOPLE-TALENTOS-CULTURA.md
agents:
  - type: "code-reviewer"
...
**Documento completo:** [docs/PLANO-NESS-PEOPLE-TALENTOS-CULTURA.md](../docs/PLANO-NESS-PEOPLE-TALENTOS-CULTURA.md)

**Código do plano:** `PPL-TC` | **Pilares:** ATS, TOF, A360 | **Commits:** `ppl-tc:`

**RF.CORE:** 01 Auth Guard | 02 Dashboard por Role — ver docs/RF-CORE-REQUISITOS.md

**RF.PEO:** 01 Gaps (Colaborador → Playbook Violado → Correção) | 02 ATS (CRUD Vagas; is_open → /carreiras)

## Task Snapshot
- **Primary goal:** ness.PEOPLE: ATS Integrado (vagas a partir de contratos), Treinamento Orientado a Falhas (OPS × competência) e Avaliação 360º.
- **Success signal:** Vagas sugeridas por demanda; gaps com sugestão de treinamento a partir de incidentes; feedback 360º estruturado.
- **Key references:**
