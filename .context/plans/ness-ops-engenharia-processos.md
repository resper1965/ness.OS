...
planVinculado: docs/PLANO-NESS-OPS-ENGENHARIA-PROCESSOS.md
agents:
  - type: "code-reviewer"
...
> Biblioteca de conhecimento e hub de métricas. OPS não executa a técnica, governa a técnica.

**Documento completo:** [docs/PLANO-NESS-OPS-ENGENHARIA-PROCESSOS.md](../docs/PLANO-NESS-OPS-ENGENHARIA-PROCESSOS.md)

**Código do plano:** `OPS-EP` | **Pilares:** EP, HI, MR | **Commits:** `ops-ep:`

**RF.CORE:** 01 Auth Guard | 02 Dashboard por Role — ver docs/RF-CORE-REQUISITOS.md

**RF.OPS.01:** Gestão de Playbooks — CRUD, Editor Markdown, Metadados (Título, Tags, Data de Revisão, Autor), playbook_id obrigatório para serviço vendável.

**RF.OPS.02:** Input de Métricas (Mensal) — Interface para Líderes: Mês/Ano, Horas Humanas Gastas, Custo Cloud (R$), SLA Atingido (Boolean) por Cliente/Contrato.

**RF.OPS.03:** Agente de Busca (RAG) — Chatbot interno; técnicos perguntam e a IA responde baseada apenas nos Playbooks cadastrados (sem alucinação).

## Task Snapshot
- **Primary goal:** OPS como guardião: Playbooks padronizados, Hub de Indicadores (API agnóstica), Mapeamento de Recursos granular.
- **Success signal:** Manuais estruturados, métricas via API de qualquer ferramenta, custo real por contrato.
- **Key references:**
