...
planVinculado: docs/PLANO-NESS-GOV-GOVERNANCA-INTERNA.md
agents:
  - type: "code-reviewer"
...
**Documento completo:** [docs/PLANO-NESS-GOV-GOVERNANCA-INTERNA.md](../docs/PLANO-NESS-GOV-GOVERNANCA-INTERNA.md)

**Código do plano:** `GOV-PN` | **Pilares:** GP, RTA | **Commits:** `gov-pn:`

**RF.CORE:** 01 Auth Guard | 02 Dashboard por Role — ver docs/RF-CORE-REQUISITOS.md

## Task Snapshot
- **Primary goal:** ness.GOV: Gestão de Políticas (versionamento) e Rastreabilidade de Aceite (NDA, termos, políticas desde o onboarding).
- **Success signal:** Políticas versionadas; aceites digitais rastreáveis por colaborador.
- **Key references:**
