  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      className={cn(
        ...
        'focus:bg-slate-700 data-[state=open]:bg-slate-700',
        inset && 'pl-8',
        className
      )}
      {...props}
  ...
  return (
    <DropdownMenuPrimitive.Item
      className={cn(
        ...
        'focus:bg-slate-700 focus:text-slate-100 data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
        inset && 'pl-8',
        className
      )}
      {...props}
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      className={cn(
        'px-2 py-1.5 text-sm font-medium text-slate-400',
        inset && 'pl-8',
        className
      )}
      {...props}
