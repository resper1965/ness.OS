...
export function AppPageHeader({ title, subtitle, actions }: AppPageHeaderProps) {
  return (
    <>
      <header
        className="fixed top-0 z-10 flex shrink-0 items-center justify-between overflow-hidden border-b border-slate-700 bg-slate-900/95 px-8 backdrop-blur supports-[backdrop-filter]:bg-slate-900/80"
        style={{
          left: `${SIDEBAR_WIDTH_PX}px`,
          right: 0,
          height: `${APP_HEADER_HEIGHT_PX}px`,
          minHeight: `${APP_HEADER_HEIGHT_PX}px`,
          maxHeight: `${APP_HEADER_HEIGHT_PX}px`,
        }}
      >
